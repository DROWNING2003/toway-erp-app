...
// appStore.switchMode(false ? 'dark' : 'light')
  ...
  <van-pull-refresh v-model="isLoading" success-text="刷新成功" @refresh="onRefresh">
    ...
    <div class="px-[25px] py-[20px] bg flex flex-col gap-20">
      ...
      <div name="快捷卡片" class="flex flex-row gap-10">
        <div name="到货管理" @click="to('arrive')" class="product-manager flex flex-col">
          <div class="p-10">
            <h1 class="product-manager-h1">到货管理</h1>
        ...
        <div class="flex flex-col gap-10">
          ...
          <div @click="to('productManager')" name="产品库" class="library flex flex-row items-center p-[15px] gap-[10px]">
      ...
      <div name="维修与工程" style="height: 250px;" class="card py-[20px]">
        <div class="flex flex-row justify-between card-head px-[20px]">
          <h1 class="product-manager-h1">维修与工程</h1>
        </div>
        <div name="统计项目" class="flex flex-row flex-wrap">
          <div @click="to('fix')" name="维修管理" class="flex flex-col p-[10px] gap-5 items-center">
